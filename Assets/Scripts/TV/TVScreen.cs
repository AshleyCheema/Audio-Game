...
public class TVScreen : MonoBehaviour
{
	...
	TVCameraController tvCameraController;
	...
	void Start ()
	{
		...
		tvCameraController = GameObject.FindObjectOfType<TVCameraController>();

		tvCameraController.SetRenderTexture();
	...
	private void OnValidate()
	{
		...
		mat.SetTexture( m_noiseTexID, noiseTexture );
		mat.SetFloat( m_noiseXSpeedID, noiseXSpeed );
		mat.SetFloat( m_noiseYSpeedID, noiseYSpeed );
		mat.SetFloat( m_noiseCutoffID, noiseCutoff );
		mat.SetTexture( m_vignetteTexID, vignetteTexture );
		mat.SetTexture( m_lineTexID, lineTexture );
		mat.SetColor( m_lineColorID, lineColor );
		mat.SetFloat( m_distortionStrengthID, distortionStrength );
	}
}
